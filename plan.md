...
- Include connection, lobby, display/audio settings, configurable controls, draft, combat HUD, pilot menu, spectator, and dedicated victory screens. Persist selectable 1280×720, 1600×900, 1920×1080, 2560×1080, 2560×1440, and 3440×1440 window resolutions. Use expand-aspect rendering so ultrawide modes reveal more arena instead of stretching it. Consolidate match state, timer, round/heat, survivors, resources, and active-profile shortcuts in a compact upper-left HUD so the arena remains unobstructed; the lobby UI is absent during the match loop.
