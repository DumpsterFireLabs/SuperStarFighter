...
- The launch catalog contains exactly 133 unlimited-stack cards across ship, shield, and weapon categories. Catalog validation rejects exact mechanical duplicates and same-stat/same-direction magnitude swaps, while 36 numeric stats plus beam, auto-repair, Afterburner, mine, cloak, and rebound-shield behavior switches provide distinct stacking axes. Seven rarity tiers use visible tier weights (Common 45%, Uncommon 27%, Rare 15%, Epic 8%, Legendary 3.3%, Mythical 1.2%, Unobtanium 0.5%); the server rolls tiers and cards authoritatively without replacement for each offer. Multiple cards enable pulse-beam, knockback, shield-ram, shield-healing, projectile-rebound, stealth, and burst-mobility builds.
