...
- Present the game with an animated splash held for at least 10 seconds, procedural neon geometry, glow, projectile and beam trails, shield arcs, impact particles, distinct color-and-pattern player identities, nameplates, synthesized placeholder sound effects, and drop-in support for original or licensed menu/gameplay/victory music. Use a 2.5-second authoritative intermission between completed rounds.
