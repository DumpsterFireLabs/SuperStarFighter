...
- The launch catalog contains exactly 130 unlimited-stack cards across ship, shield, and weapon categories. Catalog validation rejects exact mechanical duplicates and same-stat/same-direction magnitude swaps, while 34 numeric stats plus beam, auto-repair, and active Afterburner behavior switches provide distinct stacking axes. Seven rarity tiers use visible tier weights (Common 45%, Uncommon 27%, Rare 15%, Epic 8%, Legendary 3.3%, Mythical 1.2%, Unobtanium 0.5%); the server rolls tiers and cards authoritatively without replacement for each offer. Multiple cards enable pulse-beam, knockback, shield-ram, shield-healing, and burst-mobility builds.
