...
- Include connection, lobby, display/audio settings, draft, combat HUD, Escape pilot menu, spectator, and dedicated victory screens. Persist a selectable window resolution from 1280×720 through 2560×1440. Consolidate match state, timer, round/heat, survivors, resources, and combat shortcuts in a compact upper-left HUD so the arena remains unobstructed; the lobby UI is absent during the match loop.
