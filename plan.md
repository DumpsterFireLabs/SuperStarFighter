...
- The launch catalog contains exactly 60 cards across ship, shield, and weapon categories. Seven rarity tiers use visible tier weights (Common 60%, Uncommon 25%, Rare 10%, Epic 3.5%, Legendary 1.2%, Mythical 0.25%, Unobtanium 0.05%); the server rolls tiers and cards authoritatively without replacement for each offer. Multiple cards enable pulse-beam builds, including exceptional Mythical and Unobtanium transformations.
