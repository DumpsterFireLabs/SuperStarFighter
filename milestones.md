...
| 7 — Export, Documentation, and Release Candidate | In Progress | Documentation, verified Beta 1 through Beta 8 Windows client packages, and Beta 8 Linux x64 plus universal macOS client packages are complete; dedicated-server export, clean-machine acceptance, release-mode soak, signing/notarization, and final release-candidate validation remain. |
...
**Status:** In Progress — documentation completed 2026-08-25, Windows Beta 1/Beta 2/Beta 3 client packages completed 2026-08-26, Windows Beta 4/Beta 5/Beta 6 client packages completed 2026-08-27, and the Windows Beta 7 plus Windows/Linux/macOS Beta 8 client packages completed 2026-08-29; dedicated-server and final release-candidate work remains

**Outcome:** A clean checkout can produce and operate the deliverable Windows client and dedicated server.

### Delivered in 7.1–7.9
...
- Extend release packaging to produce and validate `SuperStarFighterServer.exe` alongside the completed Beta 8 clients.
