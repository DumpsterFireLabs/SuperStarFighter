...
$presetName = 'Windows Beta 8'
$releaseLabel = 'Beta 8'
$expectedGameVersion = '0.1.0-beta.8'
$expectedWindowsVersion = '0.1.0.8'
$buildRoot = Join-Path $SsfRepositoryRoot 'builds\beta-8'
$clientPath = Join-Path $buildRoot 'SuperStarFighter-Beta8.exe'
$archivePath = Join-Path $buildRoot 'SuperStarFighter-Beta8-Windows-x64.zip'
