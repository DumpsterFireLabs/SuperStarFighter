...
$presetName = 'Windows Beta 9'
$releaseLabel = 'Beta 9'
$expectedGameVersion = '0.1.0-beta.9'
$expectedWindowsVersion = '0.1.0.9'
$buildRoot = Join-Path $SsfRepositoryRoot 'builds\beta-9'
$clientPath = Join-Path $buildRoot 'SuperStarFighter-Beta9.exe'
$archivePath = Join-Path $buildRoot 'SuperStarFighter-Beta9-Windows-x64.zip'
