...
Authoritative match observations keep 128 completed heat records with contact, eliminated time, actual drafting, turnaround, builds, byes, and pickup cohorts. Server logs emit bounded summaries and participant rows; study JSON retains complete records. The repeatable bot study informs decisions but does not substitute for human counterplay or fairness acceptance. See `docs/GAMEPLAY-STUDY-2026-09-03.md` for the dated evidence and limitations.
