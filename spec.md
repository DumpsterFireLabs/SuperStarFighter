...
- Support persistent Windowed (default), desktop-native Borderless Fullscreen, and selected-resolution Exclusive Fullscreen modes with a minimum usable resolution of 1280×720 and a 1920×1080 virtual canvas. Settings provide fifteen 16:9, 16:10, 21:9, and 32:9 choices from 1280×720 through 5120×2160, including 5120×1440 super-ultrawide, without changing authoritative gameplay. Use `canvas_items` with expand aspect so wider windows expose additional horizontal space without nonuniformly stretching ships, arena geometry, or UI.
