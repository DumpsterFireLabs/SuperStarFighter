...
- Ships collide with walls, obstacles, and other ships using slide response. Pair separation transfers any wall- or cover-blocked correction to the movable ship, removes inward velocity, and applies an outward impulse so shield/fire transitions cannot retain an overlap. Base collisions deal no damage; a card-derived shield-ram stat may turn a qualifying forward shield impact into damage.
