...
const DEFAULT_CARD_PATHS: Array[String] = [
	...
	"res://data/cards/kinetic_prow.tres",
	"res://data/cards/impact_capacitor.tres",
	"res://data/cards/breach_vector.tres",
	"res://data/cards/sundering_aegis.tres",
	"res://data/cards/worldbreaker_prow.tres",
