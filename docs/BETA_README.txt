...
This beta executable is not code-signed. Windows SmartScreen may display an unrecognized-app warning. Verify the SHA-256 value supplied by the person sharing the build before running it.
