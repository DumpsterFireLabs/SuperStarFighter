extends "res://docs/card-balance-validation-2026-09-07.gd"
...
func _run() -> void:
	...
	for path in ["src/shared/combat/npc_pilot_controller.gd", "src/shared/combat/projectile_state.gd", "src/shared/combat/authoritative_world.gd", "src/shared/game_constants.gd", "docs/card-balance-focused-2026-09-07.gd", "src/test/gameplay_study.gd"]:
	...
	var output := FileAccess.open("res://docs/card-balance-focused-2026-09-07.json", FileAccess.WRITE)
	if output == null:
		quit(2)
		return
