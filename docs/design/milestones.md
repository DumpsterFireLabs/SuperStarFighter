...
| 6.28 — Objective Reliability, Combat Audio, and Disconnect Recovery | Complete | Added five-second King of the Hill and Capture the Flag respawns, per-round hill relocation, KOTH temporary-powerup defaults, flag delivery to the carrier's own base, build-sensitive weapon sound families, focus-safe pointer release, and reliable client/embedded-host disconnect cleanup; protocol 14, 2,093 assertions, 88 project checks, and real network/match/local-host flows passed. |
| 6.29 — Hunter Missiles | Complete | Added a 20-use-per-stack heat-scoped missile special with continuous in-flight forward-cone acquisition, bounded 90°/s steering, cover and overshoot lock loss, 1,100-pixel range, shield/vent counters, NPC use, synchronized inventory/projectiles, HUD/card presentation, missile visuals, and a dedicated launch cue; protocol 24, 2,998 assertions, 94 project checks, and the real ENet network gate passed. |
| 7 — Export, Documentation, and Release Candidate | In Progress | Documentation and verified Beta 1 through Beta 10 Windows client packages are complete; Beta 8 and Beta 9 also include Linux x64 and universal macOS clients, while Beta 9 adds Linux ARM64/Raspberry Pi. Dedicated-server export, clean-machine acceptance, release-mode soak, signing/notarization, and final release-candidate validation remain. |
...
| 7.5 — Windows Beta 4 Client Package | Complete | Advanced the visible/package identity to 0.1.0-beta.4 without replacing prior beta folders; exported a 127,696,704-byte embedded-PCK Windows x64 client with protocol 13 and verified 0.1.0.4 file/product metadata; packaged a 57,211,114-byte friend ZIP containing only the client, instructions, and notices; 2,036 assertions, 87 project checks, rendered startup, and all six authored music tracks passed. |
| 7.6 — Windows Beta 5 Client Package | Complete | Advanced the visible/package identity to 0.1.0-beta.5 without replacing prior beta folders; exported a 127,722,104-byte embedded-PCK Windows x64 client with protocol 14 and verified 0.1.0.5 file/product metadata; packaged a 57,236,491-byte friend ZIP containing only the client, instructions, and notices; 2,093 assertions, 88 project checks, rendered startup, real network/match/local-host flows, and all six authored music tracks passed. |
| 7.7 — Windows Beta 6 Client Package | Complete | Advanced the visible/package identity to 0.1.0-beta.6 while preserving prior beta folders; exported a 128,846,168-byte embedded-PCK Windows x64 client with protocol 14 and verified 0.1.0.6 file/product metadata; packaged a 58,360,585-byte friend ZIP containing only the client, instructions, and notices; 2,118 assertions, 88 project checks, rendered startup, and all six authored music tracks passed. |
| 7.8 — Windows Beta 7 Client Package | Complete | Advanced the visible/package identity to 0.1.0-beta.7 while preserving prior beta folders; exported a 128,856,168-byte embedded-PCK Windows x64 client with protocol 14 and verified 0.1.0.7 file/product metadata; packaged a 58,369,826-byte friend ZIP containing only the client, instructions, and notices; 2,546 assertions, 90 project checks, rendered startup, and all six authored music tracks passed. |
| 7.9 — Windows, Linux, and macOS Beta 8 Client Packages | Complete | Advanced the visible/package identity to 0.1.0-beta.8 while preserving prior beta folders; exported embedded-PCK Windows x64, Linux x64, and universal macOS clients; packaged 58,379,558-byte Windows, 48,441,303-byte Linux, and 80,446,659-byte macOS friend ZIPs; and passed 2,568 assertions, 90 project checks, Windows rendered/audio verification, Linux ELF verification, macOS app/metadata/arm64/x86_64 verification, and complete archive read-throughs. |
| 7.10 — Windows, Linux, and macOS Beta 9 Client Packages | Complete | Advanced the visible/package identity to 0.1.0-beta.9 while preserving prior beta folders; exported embedded-PCK Windows x64, Linux x64, Linux ARM64/Raspberry Pi, and universal macOS clients; rebuilt 58,471,122-byte Windows, 48,533,470-byte Linux x64, 48,054,268-byte Linux ARM64, and 80,539,678-byte macOS friend ZIPs; and passed 2,815 assertions, 93 project checks, Windows metadata/rendered/audio verification, architecture-specific Linux ELF/package verification, macOS app/metadata/arm64/x86_64 verification, complete archive read-throughs, and exact packaged-guide verification. |
| 7.11 — Windows Beta 10 Client Package | Complete | Advanced the visible/package identity to 0.1.0-beta.10 while preserving prior beta folders; exported a 129,139,576-byte embedded-PCK Windows x64 client with protocol 24 and verified 0.1.0.10 file/product metadata; packaged a 58,614,168-byte friend ZIP containing only the client, instructions, and notices; 2,998 assertions, 94 project checks, rendered startup, and all six authored music tracks passed. Linux and macOS Beta 10 packages remain unbuilt. |
...
**Status:** In Progress — documentation completed 2026-08-25, Windows Beta 1/Beta 2/Beta 3 client packages completed 2026-08-26, Windows Beta 4/Beta 5/Beta 6 client packages completed 2026-08-27, Windows Beta 7 plus Windows/Linux/macOS Beta 8 completed 2026-08-29, Windows/Linux/macOS Beta 9 completed 2026-08-30, and Windows Beta 10 completed 2026-09-01; dedicated-server and final release-candidate work remains

**Outcome:** A clean checkout can produce and operate the deliverable Windows client and dedicated server.

### Delivered in 7.1–7.11
...
- Advanced the shared, project, main-screen, Windows metadata, preset, executable, archive, and tester-guide identity to `0.1.0-beta.4` / **BETA 4**, preserving Beta 1 through Beta 3 in their original folders.
- Produced `SuperStarFighter-Beta4.exe` at 127,696,704 bytes and `SuperStarFighter-Beta4-Windows-x64.zip` at 57,211,114 bytes under ignored `builds/beta-4/`; SHA-256 values are `FC442323F9FCF3FD84B0FC161685F4DBE751AC31BF0F9F4CC5354930528805CB` and `64D4F08A3E1CB4AC53C0E7B0C2B59C0E995EDFA61D5D03399E5BE57EDF35C237` respectively.
- Advanced the shared, project, main-screen, Windows metadata, preset, executable, archive, tester guide, and network identity to `0.1.0-beta.5` / **BETA 5** / protocol 14 while preserving Beta 1 through Beta 4.
- Produced `SuperStarFighter-Beta5.exe` at 127,722,104 bytes and `SuperStarFighter-Beta5-Windows-x64.zip` at 57,236,491 bytes under ignored `builds/beta-5/`; SHA-256 values are `E29264CD887E8D0D9ACD5F03A83647550F422C43FB39E93C6766E7552A3F4728` and `76B82C8A343A49ADC1BE094C2144055F53FEF89A279F7E01E561203FA9D0C541` respectively.
- Advanced the shared, project, main-screen, Windows metadata, preset, executable, archive, and tester-guide identity to `0.1.0-beta.6` / **BETA 6**, preserving Beta 1 through Beta 5.
- Produced `SuperStarFighter-Beta6.exe` at 128,846,168 bytes and `SuperStarFighter-Beta6-Windows-x64.zip` at 58,360,585 bytes under ignored `builds/beta-6/`; SHA-256 values are `752D6E0250E470B4BF1009F9C7F29F4F540D0C1E895D9DDDE277CC4D998BD541` and `76A40B2281F6F03CC63413AD74AFE8F8683693514FC68281D9BA5D0101486BE5` respectively.
- Advanced the shared, project, main-screen, Windows metadata, preset, executable, archive, and tester-guide identity to `0.1.0-beta.7` / **BETA 7**, preserving Beta 1 through Beta 6.
- Produced `SuperStarFighter-Beta7.exe` at 128,856,168 bytes and `SuperStarFighter-Beta7-Windows-x64.zip` at 58,369,826 bytes under ignored `builds/beta-7/`; SHA-256 values are `E9EFB1C35BF8678F843ACD13C4D6981801B21124C02D8E1AF8DFBDCA78155D71` and `68B1CAB3BAC480C45AED37676629358CBC7EAF91E89A8BA39654DAED01C6967B` respectively.
- Advanced the shared, project, main-screen, Windows metadata, presets, executables, archives, and tester-guide identity to `0.1.0-beta.8` / **BETA 8**, preserving Beta 1 through Beta 7 and adding the first Linux x64 client package.
- Produced `SuperStarFighter-Beta8.exe` at 128,864,664 bytes and `SuperStarFighter-Beta8-Windows-x64.zip` at 58,379,558 bytes under ignored `builds/beta-8/`; SHA-256 values are `2384822DACA6CC582BFFD08BF6A3176F278EB9EBF60ECAA86BCC85C914266B84` and `46CB4EBD653CE9A8CD6D2C6BF0DEE350BDFFE6E6DDE7A6DCB1E2536DDAADBED8` respectively.
- Produced `SuperStarFighter-Beta8.x86_64` at 93,256,392 bytes and `SuperStarFighter-Beta8-Linux-x64.zip` at 48,441,303 bytes under ignored `builds/beta-8/`; SHA-256 values are `88C14E59ACC43009CD62F9F7D6E8CD79ABEBA1E6AE59948CA849B7A19044D84F` and `DA6C5A5DEB654894C1FEB562C38CCEEA8CA9996AF86B97AF4CE9F2800FC4030A` respectively.
- Produced `SuperStarFighter-Beta8-macOS-universal.zip` at 80,446,659 bytes under ignored `builds/beta-8/`; SHA-256 is `A132AC7D3C84A4666331EBF5758FE33970B012435F38B3F42A8104DE1A4E3D2A`. The archive contains an unsigned `.app` with preserved executable permissions, `arm64` and `x86_64` Mach-O slices, Beta README, and Godot third-party notice.
- Advanced the shared, project, main-screen, Windows metadata, presets, executables, archives, and tester-guide identity to `0.1.0-beta.9` / **BETA 9**, preserving Beta 1 through Beta 8 in their original folders.
- Rebuilt `SuperStarFighter-Beta9.exe` at 128,959,784 bytes and `SuperStarFighter-Beta9-Windows-x64.zip` at 58,471,122 bytes under ignored `builds/beta-9/`; SHA-256 values are `BE9B67565C8A3BE39B19A9B9E2154E62397149025F7909FA76795E13007091EC` and `BDD93BEAB34A67D75C2524C5F280AE5BD5DE81440892F55C855315128AB1F59B` respectively.
- Rebuilt `SuperStarFighter-Beta9.x86_64` at 93,351,512 bytes and `SuperStarFighter-Beta9-Linux-x64.zip` at 48,533,470 bytes under ignored `builds/beta-9/`; SHA-256 values are `3920B7923D22E37ED0CA527252A024806ECC0EFE262AD9894281141EC2E5758D` and `90A5B8FEBAF79799F1E27D7119B6E9819515FD3BAAD67BB980D7DF962C20B16F` respectively.
- Rebuilt `SuperStarFighter-Beta9.arm64` at 86,911,528 bytes and `SuperStarFighter-Beta9-Linux-arm64.zip` at 48,054,268 bytes under ignored `builds/beta-9/`; SHA-256 values are `D9D0E64E67706CFE094DBCE88FF244CA4E6FF481BB49BA9CBA262792CCF42484` and `B7B567937148C64A5C6ACF7123F3049EC713D395BA8921957921E6E708B4AA26` respectively.
- Rebuilt `SuperStarFighter-Beta9-macOS-universal.zip` at 80,539,678 bytes under ignored `builds/beta-9/`; SHA-256 is `A8DEE3DB7086D085C2E029E6E7927221466E4BB40FCD0FB6BEB5CE3167C7A845`. The archive contains an unsigned `.app` with preserved executable permissions, `arm64` and `x86_64` Mach-O slices, Beta README, and Godot third-party notice.
- Advanced the shared, project, main-screen, Windows metadata, presets, executables, archives, and tester-guide identity to `0.1.0-beta.10` / **BETA 10**, preserving Beta 1 through Beta 9 in their original folders.
- Produced `SuperStarFighter-Beta10.exe` at 129,139,576 bytes and `SuperStarFighter-Beta10-Windows-x64.zip` at 58,614,168 bytes under ignored `builds/beta-10/`; SHA-256 values are `7BAECBBA56EB9339F00D2C10AC9377543A82B3A4D8BBCEB40045D120BAB14BBF` and `78EDD66C751FE75BB563CCA9CFEB0D2D071662FB46E8599C0255FA42A1274C15` respectively. Linux and macOS Beta 10 packages have not been built.
...
- Extend release packaging to produce and validate `SuperStarFighterServer.exe` alongside the completed Beta 10 Windows client and Beta 9 cross-platform clients.
...
- Beta 4 client acceptance passed 2,036 deterministic assertions and 87 project checks; its embedded executable reported the expected client-ready marker and one menu, four gameplay, and one victory track without runtime errors. The ZIP contains only the Beta 4 executable, updated Beta README, and Godot third-party notice.
- Beta 5 client acceptance passed 2,093 deterministic assertions and 88 project checks plus the real network, two-match/rematch, and local-host lifecycle gates; its embedded executable reported the expected client-ready marker and one menu, four gameplay, and one victory track without runtime errors. The ZIP contains only the Beta 5 executable, updated Beta README, and Godot third-party notice.
- Beta 6 client acceptance passed 2,118 deterministic assertions and 88 project checks; its embedded executable reported the expected client-ready marker and one menu, four gameplay, and one victory track without runtime errors. The ZIP contains only the Beta 6 executable, updated Beta README, and Godot third-party notice.
- Beta 7 client acceptance passed 2,546 deterministic assertions and 90 project checks; its embedded executable reported the expected client-ready marker and one menu, four gameplay, and one victory track without runtime errors. The ZIP contains only the Beta 7 executable, updated Beta README, and Godot third-party notice.
- Beta 8 client acceptance passed 2,568 deterministic assertions and 90 project checks; the Windows embedded executable passed metadata, rendered startup, and six-track inventory verification; the Linux embedded executable passed ELF signature, x86-64 architecture, packaged-version, and ZIP integrity checks; and the macOS app passed bundle metadata, Unix permissions, universal `arm64`/`x86_64` Mach-O, packaged-version, and ZIP integrity checks. Native Linux/macOS launch verification and macOS signing/notarization remain for their respective hosts.
- Beta 9 client acceptance passed 2,815 deterministic assertions and 93 project checks; the Windows embedded executable passed metadata, rendered startup, and six-track inventory verification; Linux x64 and ARM64 executables passed ELF signature, architecture, packaged-version, and ZIP integrity checks; and the macOS app passed bundle metadata, Unix permissions, universal `arm64`/`x86_64` Mach-O, packaged-version, and ZIP integrity checks. Native Linux/macOS/Raspberry Pi launch verification and macOS signing/notarization remain for their respective hosts.
- Beta 10 Windows client acceptance passed 2,998 deterministic assertions and 94 project checks; the embedded x64 executable passed 0.1.0.10 file/product metadata, rendered startup, and six-track inventory verification; and the friend ZIP contains only the executable, Beta README, and third-party notice. Linux and macOS Beta 10 packages remain unbuilt.
...
- Implement destructible cover and teleporter relays as explicit future-release priorities described in the [Arena Mechanics Roadmap](../ARENA-MECHANICS-ROADMAP.md), without weakening server authority, prediction, accessibility, or deterministic tests.
...
R12 mixing implementation and recorded evidence are delivered, with actual human listening still open. See [the review](../archive/REVIEW-2026-09-03.md) and [audio study](../archive/AUDIO-STUDY-2026-09-04.md). Remaining review inventory: R12 and R16–R28.
...
Final foundation passes **167 checks and 5,678 assertions**, including the expected failing-exit-path check. The source/asset inventory now covers all fourteen runtime assets with hashes and provenance dispositions; engine/component notices are generated and included in packaging. R28 is complete under the owner's recorded asset attestations. R12 is conditionally complete on the validated G733 stereo setup; ordinary-speaker coverage is deferred. At this batch-nine checkpoint, four items remained: R22, R24, R25, and R27. The subsequent Solar Current follow-up completed R22, leaving **R24, R25, and R27** in the current inventory. Details and evidence are in [the review](../archive/REVIEW-2026-09-03.md) and [attribution inventory](../ATTRIBUTION.md).
