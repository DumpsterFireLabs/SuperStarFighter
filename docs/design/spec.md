...
- The host supplies a bounded server display name, gameplay UDP port, and required 1–64 printable-character lobby password. The fixed discovery port `7359` is reserved and cannot also be selected as the gameplay port.
