...
```powershell
& .\tools\run-tests.ps1
& .tools/godot/Godot_v4.7.2-stable_win64_console.exe --headless --path . --log-file .tools/card-balance-validation.log --script docs/archive/card-balance-validation-2026-09-07.gd
& .tools/godot/Godot_v4.7.2-stable_win64_console.exe --headless --path . --log-file .tools/npc-draft-sampling.log --script docs/archive/npc-draft-sampling-2026-09-07.gd
```
