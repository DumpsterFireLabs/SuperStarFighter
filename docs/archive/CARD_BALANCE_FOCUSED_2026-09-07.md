...
```powershell
& .tools/godot/Godot_v4.7.2-stable_win64_console.exe --headless --path . --log-file .tools/card-focused.log --script docs/archive/card-balance-focused-2026-09-07.gd
& .tools/godot/Godot_v4.7.2-stable_win64_console.exe --headless --path . --log-file .tools/card-balance-trials.log --script docs/archive/card-balance-trials-2026-09-07.gd
```
