extends "res://docs/archive/card-balance-focused-2026-09-07.gd"
...
func _run() -> void:
	...
	for path in ["docs/archive/card-balance-trials-2026-09-07.gd", "docs/archive/card-balance-focused-2026-09-07.gd", "docs/archive/card-balance-validation-2026-09-07.gd", "src/test/gameplay_study.gd", "src/shared/combat/npc_pilot_controller.gd", "src/shared/combat/authoritative_world.gd", "src/shared/combat/shield_state.gd", "src/shared/game_constants.gd"]:
	...
	var output := FileAccess.open("res://docs/archive/card-balance-trials-2026-09-07.json", FileAccess.WRITE)
	if output == null:
		quit(2)
		return
