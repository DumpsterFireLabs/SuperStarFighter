Super Star Fighter - Dedicated Server (Windows x64 / Linux x64 / Linux ARM64, Beta 14)
...
game/protocol version on clients: 0.1.0-beta.14 (compatibility 44, binary packets 17).
...
example as /etc/systemd/system/ssf.service:
  ...
  [Unit]
  Description=Super Star Fighter Beta 14 dedicated server
